        ...
        function($parse, $document, $compile, $interpolate, optionParser) {
            return {
                ...
                link: function(originalScope, element, attrs, modelCtrl) {
                    ...
                    var selectMax = attrs.maxSelection;
                    ...
                    function selectMultiple(item) {
                        ...
                        if (scope.maxSelection) {
                            if (!item.checked && _.filter(scope.items, function(e) {
                                return e.checked;
                            }).length < scope.maxSelection) {
                                item.checked = true;
                            } else {
                                item.checked = false;
                            }
                    ...
                    function setModelValue(isMultiple) {
                        ...
                        if (isMultiple) {
                            ...
                            angular.forEach(scope.items, function(item) {
                                if (item.checked) {
                                    if (scope.maxSelection) {
                                        if (value.length < scope.maxSelection) {
...
angular.module("multiselect.tpl.html", []).run(["$templateCache",
